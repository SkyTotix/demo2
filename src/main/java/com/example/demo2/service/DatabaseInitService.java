...
public class DatabaseInitService {
    ...
    private static void crearTablaUsuarios(Statement stmt) throws Exception {
        System.out.println("📝 Ejecutando creación de tabla USUARIOS...");
        ...
        try {
            ...
            System.out.println("✅ Índice idx_usuarios_username creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_usuarios_username ya existe o error: " + e.getMessage());
        }
        
        try {
            stmt.execute("CREATE INDEX idx_usuarios_email ON usuarios(email)");
            System.out.println("✅ Índice idx_usuarios_email creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_usuarios_email ya existe o error: " + e.getMessage());
        }
    }
    
    /**
     * Crea la tabla lectores
     */
    private static void crearTablaLectores(Statement stmt) throws Exception {
        System.out.println("📝 Ejecutando creación de tabla LECTORES...");
        ...
        System.out.println("✅ Tabla 'lectores' creada exitosamente");
        
        // Crear índices
        try {
            stmt.execute("CREATE INDEX idx_lectores_codigo ON lectores(codigo_lector)");
            System.out.println("✅ Índice idx_lectores_codigo creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_lectores_codigo ya existe o error: " + e.getMessage());
        }
        
        try {
            stmt.execute("CREATE INDEX idx_lectores_documento ON lectores(numero_documento)");
            System.out.println("✅ Índice idx_lectores_documento creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_lectores_documento ya existe o error: " + e.getMessage());
        }
        
        try {
            stmt.execute("CREATE INDEX idx_lectores_email ON lectores(email)");
            System.out.println("✅ Índice idx_lectores_email creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_lectores_email ya existe o error: " + e.getMessage());
        }
        
        try {
            stmt.execute("CREATE INDEX idx_lectores_estado ON lectores(estado)");
            System.out.println("✅ Índice idx_lectores_estado creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_lectores_estado ya existe o error: " + e.getMessage());
        }
    }
    ...
    private static void crearTablaLibros(Statement stmt) throws Exception {
        System.out.println("📝 Ejecutando creación de tabla LIBROS...");
        ...
        try {
            ...
            System.out.println("✅ Índice idx_libros_isbn creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_libros_isbn ya existe o error: " + e.getMessage());
        }
        
        try {
            stmt.execute("CREATE INDEX idx_libros_titulo ON libros(titulo)");
            System.out.println("✅ Índice idx_libros_titulo creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_libros_titulo ya existe o error: " + e.getMessage());
        }
    }
    ...
    private static void crearTablaPrestamos(Statement stmt) throws Exception {
        System.out.println("📝 Ejecutando creación de tabla PRESTAMOS...");
        ...
        System.out.println("✅ Tabla 'prestamos' creada exitosamente");
        
        // Crear índices
        try {
            stmt.execute("CREATE INDEX idx_prestamos_codigo ON prestamos(codigo_prestamo)");
            System.out.println("✅ Índice idx_prestamos_codigo creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_prestamos_codigo ya existe o error: " + e.getMessage());
        }
        
        try {
            stmt.execute("CREATE INDEX idx_prestamos_libro ON prestamos(libro_id)");
            System.out.println("✅ Índice idx_prestamos_libro creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_prestamos_libro ya existe o error: " + e.getMessage());
        }
        
        try {
            stmt.execute("CREATE INDEX idx_prestamos_lector ON prestamos(lector_id)");
            System.out.println("✅ Índice idx_prestamos_lector creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_prestamos_lector ya existe o error: " + e.getMessage());
        }
        
        try {
            stmt.execute("CREATE INDEX idx_prestamos_estado ON prestamos(estado)");
            System.out.println("✅ Índice idx_prestamos_estado creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_prestamos_estado ya existe o error: " + e.getMessage());
        }
        
        try {
            stmt.execute("CREATE INDEX idx_prestamos_fecha_prestamo ON prestamos(fecha_prestamo)");
            System.out.println("✅ Índice idx_prestamos_fecha_prestamo creado");
        } catch (Exception e) {
            System.out.println("⚠️ Índice idx_prestamos_fecha_prestamo ya existe o error: " + e.getMessage());
        }
    }
    ...
    public static boolean verificarTablas() {
        ...
        try (Connection conn = DatabaseManager.getInstance().getConnection()) {
            boolean usuariosExiste = existeTabla(conn, "USUARIOS");
            boolean lectoresExiste = existeTabla(conn, "LECTORES");
            boolean librosExiste = existeTabla(conn, "LIBROS");
            boolean prestamosExiste = existeTabla(conn, "PRESTAMOS");
